...
kubectl label configmap sx-extcfg-opensearch-service-init app.kubernetes.io/component=extcfg
...
kubectl label configmap sx-extcfg-nginx-conf-demo-conf app.kubernetes.io/component=extcfg
...
kubectl label configmap sx-extcfg-aggregator-properties app.kubernetes.io/component=extcfg
...
kubectl label configmap sx-extcfg-data-collector-properties app.kubernetes.io/component=extcfg
...
kubectl label configmap sx-extcfg-image-optimization-properties app.kubernetes.io/component=extcfg
...
kubectl label configmap sx-extcfg-ingestion-properties app.kubernetes.io/component=extcfg
...
kubectl label secret sx-extsec-opensearch-component-secrets-properties app.kubernetes.io/component=extsec
...
kubectl label secret sx-extsec-opensearch-secrets-properties app.kubernetes.io/component=extsec
